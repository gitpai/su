...
public class SmsDemo {
	...
	//替换成你的AK
	final static String accessKeyId = "LTAICXDB8Bw3CNqw";//你的accessKeyId,参考本文档步骤2
	final static String accessKeySecret = "Xz0vMz6xKuZ6qJ1gMtk3ukcMW3VYiM";//你的accessKeySecret，参考本文档步骤2
